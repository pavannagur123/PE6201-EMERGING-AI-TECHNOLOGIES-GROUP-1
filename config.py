...
def data_root():
    ...
    for c in _CANDIDATES:
        # The released reference bundle can contain only the fixture set
        # for the team's selected problem. Requiring both directories made
        # an otherwise valid Problem A bundle fail before its first tool call.
